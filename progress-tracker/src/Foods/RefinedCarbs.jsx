...
const RefinedCarbs = () => {
  ...
  const category = "refined-carbs"; // Unique category for this page
  ...
  // Handle adding a video for "refined-carbs" category
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="max-w-3xl bg-white shadow-2xl rounded-lg p-6 text-center">
        ...
        <p className="text-gray-700 text-lg mb-6">
          Refined carbohydrates, commonly found in white bread, pastries, and sugary snacks, are stripped of nutrients and fiber.
        </p>
