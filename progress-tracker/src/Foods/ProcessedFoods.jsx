...
const ProcessedFoods = () => {
  ...
  const category = "processed-foods"; // Unique category for this page
  ...
  // Handle adding a video for "processed-foods" category
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="max-w-3xl bg-white shadow-2xl rounded-lg p-6 text-center">
        ...
        <p className="text-gray-700 text-lg mb-6">
          Processed foods often contain excessive sugars, unhealthy fats, and preservatives that can lead to various health issues such as obesity, heart disease, and diabetes.
        </p>
