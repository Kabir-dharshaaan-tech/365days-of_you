...
const ArtificialColor = () => {
  ...
  const category = "artificial-color"; // Unique category for this page
  ...
  // Handle adding a video for "artificial-color" category
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="max-w-3xl bg-white shadow-2xl rounded-lg p-6 text-center">
        ...
        <p className="text-gray-700 text-lg mb-6">
          Artificial colors and preservatives are commonly found in processed foods, candies, and soft drinks. 
          These chemicals have been linked to allergic reactions, hyperactivity, and long-term health risks like organ damage and hormonal imbalance.
        </p>
