...
const CoolDrinks = () => {
  ...
  const category = "cool-drinks"; // Unique category for this page
  ...
  // Handle adding a video for "cool-drinks" category
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4">
      <div className="max-w-3xl bg-white shadow-2xl rounded-lg p-6 text-center">
        ...
        <p className="text-gray-700 text-lg mb-6">
          Carbonated and energy drinks contain excessive sugar and chemicals that cause dehydration, weaken bones, and accelerate skin aging. 
          These drinks also contribute to obesity and hormonal imbalances.
        </p>
